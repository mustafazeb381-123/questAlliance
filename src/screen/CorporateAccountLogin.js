          ...
          <ScrollView>
            <CorporateAccountHeader />
              ...
              <View style={styles.remembarView}>
                  ...
                  <View>
                      <TouchableOpacity onPress={()=> {navigation.navigate("CorporateAccountForgetPassword")}}>
              ...
              <View style={{width:'100%', justifyContent:'center', alignItems:'center', paddingHorizontal:20, marginTop:20, }}>
                  <TouchableOpacity style={{justifyContent:'center', alignItems:'center', backgroundColor:'#2662b0', width:'100%', height:52, borderRadius:10}}>
