          ...
          <View style={{width:'100%', paddingHorizontal:20, marginTop:29}}>
              ...
              <View style={{ width: '100%', paddingHorizontal: 20, marginTop: 29 }}>
                  ...
                  <Stack space={4} w="100%"  mx="auto">
                      ...
                      <Input size="md" placeholder=" Date of Incorporation*" />
                      ...
                      <Input size="md" placeholder=" Contact No." />
              ...
              <View style={{ width: '100%', justifyContent: 'center', alignItems: 'flex-end' , marginVertical:20, paddingHorizontal:20}}>
                  <TouchableOpacity onPress={()=> {navigation.navigate("AddNewCompany")}} style={{height:45, width:145, justifyContent:'center', alignItems:'center', backgroundColor:'#2662b0', borderRadius:5 }}>
