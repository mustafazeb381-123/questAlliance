    ...
    return (
        <View style={styles.mainView}>
            ...
            <View style={{ width: '100%', marginTop: 49, justifyContent: 'center', alignItems: 'center' }}>
                <TouchableOpacity onPress={() => navigation.navigate("CorporateSignup")} style={{ justifyContent: 'center', alignItems: 'center', backgroundColor: '#2662b0', height: 40, width: 280, borderRadius: 10 }}>
