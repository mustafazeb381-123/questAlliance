  ...
  return (
      <View style={styles.mainView}>
          ...
          <View style={styles.header}>
              ...
              <AntDesign name="left" size={20} color="#2662b0" />
                  <Text style={{ color: '#2662b0', fontFamily: fonts.semibold, fontSize: 19 , paddingStart:10}}>My Loan</Text>
              </View>
                      ...
                      <>
                          <View style={{
                              ...
                              <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                  ...
                                  <Text style={{color:'black', fontFamily:fonts.bold, fontSize:18}}>Loan Approval Summary</Text>
                              </View>
                              ...
                              <View style={{ width: '100%', justifyContent: 'center', alignItems: 'center', height: 50, paddingTop: 20 }}>
                                  ...
                                  <TouchableOpacity style={{ justifyContent: 'center', alignItems: 'center', height: 50, width: 234, borderRadius: 10, backgroundColor: '#2662b0' }} >
                                      <Text style={{ color: "white" }}>Apply for Re-finance</Text>
                                  </TouchableOpacity>
