...
const ApplicantsConfirmation = (props) => {
      ...
      <View style={{ flex: 1, backgroundColor: "white", width:'100%' }}>
          ...
          <ScrollView style={{ marginBottom: 10 }}>
              ...
              <View style={{ padding: 16 , width:'100%'}}>
                  <Text style={styles.blacktitle}>Applicants(s) Confirmation{'\n' }Decleration</Text>

              </View>
              <View style={{width:'100%', justifyContent:'center', alignItems:'center'}}>
              <Divider w="92%"  bg="black"/>
              ...
              <View style={styles.bottomButton}>
                  ...
                  <TouchableOpacity onPress={() => navigation.navigate('Summary')} style={{
                      backgroundColor: '#2662b0', height: 45, width: 150, justifyContent: 'center', alignItems: 'center', borderRadius: 5
                  }}>
                      <Text style={{ color: 'white', fontSize: 18, fontFamily: fonts.regular }}>
                          Continue
